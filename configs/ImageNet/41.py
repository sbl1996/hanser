...
from hanser.models.imagenet.regnet.resnet import regnety_4_0GF
...
ds_train, ds_eval, steps_per_epoch, eval_steps = make_imagenet_dataset(
    ...
    cache_decoded_image=False, batch_transform=batch_transform)
...
base_lr = 0.1
epochs = 200
lr_schedule = CosineLR(base_lr * (batch_size // 128), steps_per_epoch, epochs=epochs, min_lr=0,
                       warmup_epoch=5, warmup_min_lr=0)
optimizer = SGD(lr_schedule, momentum=0.9, weight_decay=5e-5, nesterov=True)
