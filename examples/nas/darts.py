...
from hanser.models.darts.genotypes import set_primitives, PRIMITIVES_darts
...
drop_path = 0.6
model = Network(16, 8, 4, 4, 3, drop_path, 10)
...
trainer.fit(epochs, ds_train, ds_search, steps_per_epoch, ds_test, test_steps,
            val_freq=5, callbacks=[DropPathRateSchedule()])