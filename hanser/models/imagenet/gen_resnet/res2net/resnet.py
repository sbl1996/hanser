...
from hanser.models.imagenet.gen_resnet.resnet import ResNet as GenResNet


class ResNet(GenResNet):

    def __init__(self, block, layers, base_width=26, scale=4, zero_init_residual=False,
                 num_classes=1000, stages=(64, 64, 128, 256, 512)):
        super().__init__(
            block, layers, num_classes, stages,
            base_width=base_width, scale=scale, zero_init_residual=zero_init_residual,
        )
