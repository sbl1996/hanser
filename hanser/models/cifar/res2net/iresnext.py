...
class Bottleneck(Layer):
    ...
    def __init__(self, in_channels, channels, stride, base_width, scale, cardinality,
        ...
        self.bn1 = Norm(width)
        self.act1 = Act()
        self.conv2 = Res2Conv(width, width, kernel_size=3, stride=stride, scale=scale, groups=cardinality,
...
class ResNeXt(Model):
    ...
    def __init__(self, depth, base_width=24, scale=4, cardinality=6, num_classes=10, stages=(64, 64, 128, 256)):
        super().__init__()
        self.stages = stages
        block = Bottleneck
        layers = [(depth - 2) // 9] * 3
        ...
        self.layer1 = self._make_layer(
            ...
            base_width=base_width, scale=scale, cardinality=cardinality)
