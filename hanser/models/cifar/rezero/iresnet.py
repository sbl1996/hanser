...
class BasicBlock(Layer):
    ...
    def __init__(self, in_channels, channels, stride, dropout, drop_path, rezero,
        ...
        self.rezero = ReZero() if rezero else Identity()
...
class ResNet(Model):
    ...
    def __init__(self, depth, block='basic', dropout=0, drop_path=0, rezero=True,
        ...
        self.layer1 = self._make_layer(
            ...
            dropout=dropout, drop_path=drop_path, rezero=rezero)
