...
import hanser.datasets.tfds.segmentation.voc
...
def make_dataset(
    ...
    ds_train = tfds.load("voc_seg", split=f"train+sbd", data_dir=data_dir,
                         shuffle_files=True, read_config=read_config, as_supervised=True)
    ds_val = tfds.load("voc_seg", split=f"validation", data_dir=data_dir,
