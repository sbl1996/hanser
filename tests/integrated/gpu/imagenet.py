# !mkdir -p tfrecords
# !cp -rn ./drive/MyDrive/datasets/ImageNet/* ./tfrecords
...
train_files = ["./tfrecords/train-%05d-of-01024" % i for i in range(16)]
eval_files = ["./tfrecords/validation-%05d-of-00128" % i for i in range(4)]
